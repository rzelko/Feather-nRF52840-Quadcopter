...
#define BR 10   // MOTOR M1 (m0)
#define BL 11   // MOTOR M2 (m1)
#define FL 13   // MOTOR M3 (m2)
#define FR 12   // MOTOR M4 (m3)
...
public:
    //Constructor:
    FlightInterfaceModule(uint8_t pinBat = BAT_LVL); //(uint8_t pin = PWR_CONTROL, uint8_t pinBat = BAT_LVL);
