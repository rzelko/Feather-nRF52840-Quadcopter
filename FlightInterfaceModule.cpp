...
//Constructor  "deleted uint8_t pin," from declaration b/c PWR_CONTROL has been eliminated
FlightInterfaceModule::FlightInterfaceModule(uint8_t pinBat)
{
